...
function SigninForm() {
  ...
  const { checkAuthUser, storeToken, isLoading: isUserLoading } = useUserContext()
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">Please enter your details to access collections</p>
